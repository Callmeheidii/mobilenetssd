...
lineaccesstoken = 'v6oM4iGK4NUIYNmLUKDFk0hEdOnQdjEM3HGppBgj9xYFcEOFs3iPc5BSHyuU7MA9ufZDuqQicxl8kcddBMfANxLWRnJ8NXgE2VKkr1kGxydCkZAvYi6eAbNnq5Ho2COLmmQkRgwRjB4tHmZYXT9h6wdB04t89/1O/w1cDnyilFU='
...
def event_handle(event,json_line):
    ...
    if msgType == "text":
        ...
        if (msg == "หวัดดี") :
            ...
            replyObj = TextSendMessage(text="ยุ่งไรอะ")
            line_bot_api.reply_message(rtoken, replyObj)
        elif (msg == "กินข้าวยัง") :
            replyObj = TextSendMessage(text="ไม่ยุ่งดิ้")
            line_bot_api.reply_message(rtoken, replyObj)
        elif msg == "covid" :
            ...
            url = "https://dialogflow.cloud.google.com/v1/integrations/line/webhook/423c6d7c-83c8-43c0-b923-0545413e3c13"
